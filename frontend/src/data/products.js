...
const vendors = [
  ...
  { name: 'Pixel Forge', avatar: 'PF' },
  { name: 'Code Atlas', avatar: 'CA' },
];
...
export const getProductById = (id) => {
  ...
  return {
    ...product,
    image: `https://picsum.photos/seed/scriptbay-${product.id}/1200/900`,
    description:
...
export const getRelatedProducts = (id, category, limit = 4) =>
  products.filter((item) => item.id !== Number(id) && item.category === category).slice(0, limit);
